...
const ldi_arr = [0, 0, 0];
const tri_arr = [0, 0, 0];
const step_arr = [0, 0, 0];
const tDelta_arr = [0, 0, 0];
const tNext_arr = [0, 0, 0];
const vec_arr = [0, 0, 0];
const normed_arr = [0, 0, 0];
const base_arr = [0, 0, 0];
const max_arr = [0, 0, 0];
const left_arr = [0, 0, 0];
const result_arr = [0, 0, 0];
/**
...
function sweep_impl(getVoxel, callback, vec, base, max, epsilon) {
    ...
    function handleCollision() {
        ...
        initSweep();
        if (max_t === 0)
            return true; // No vector left to sweep
        return false;
    }
    /**
